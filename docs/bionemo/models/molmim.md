...
**Other Properties Related to Input:** Maximum input length is 128 tokens. Pretraining dataset samples were randomly split into train, validation, and test sets ( 99% / 0.5% / 0.5% ). <br>
