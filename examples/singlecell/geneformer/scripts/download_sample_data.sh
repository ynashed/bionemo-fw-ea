...
# TODO TODO TODO
aws s3 cp s3://bionemo-ci/test-data/singlecell/singlecell-testdata-20240403.tar.gz $DATA_PATH --endpoint-url https://pbss.s8k.io
# TODO TODO TODO, we want to it to unpack the correct directory structure, which will be in tests/data
tar -xvf $DATA_PATH/singlecell-testdata-20240403.tar.gz -C $DATA_PATH
