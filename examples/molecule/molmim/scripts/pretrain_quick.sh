...
####
# Example shell script to run MolMIM data processing or training.
####

### CONFIG ###
CONFIG_FILE=pretrain_xsmall_canonicalized
PROJECT=MolMIM
...
RUN_SCRIPT_DIRECTORY="${PROJECT_MOUNT}/examples/molecule/molmim"

usage() {
cat <<EOF
USAGE: pretrain_quick.sh
MolMIM pretrain script
----------------------------------------
