...
class AsyncWorkQueue:
    def __init__(self, max_workers: int = 5, use_processes: bool = False) -> None:
        ...
        :param max_workers: The maximum number of worker threads or processes.
    ...
    def get_completed_tasks(self) -> List[concurrent.futures.Future]:
        ...
        :return: A list of Future objects that are completed.
        """
        with self.lock:
    ...
    def get_pending_tasks(self) -> List[concurrent.futures.Future]:
        ...
        :return: A list of Future objects that are not yet completed.
        """
        with self.lock:
