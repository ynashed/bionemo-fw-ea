...
def test_add_cls_and_eos_tokens_both_tokens():
    ...
    augmented_sequence, augmented_loss_mask, augmented_labels = add_cls_and_eos_tokens(
        sequence, loss_mask, labels, cls_token=0, eos_token=4
    )
...
def test_add_cls_and_eos_tokens_only_cls():
    ...
    augmented_sequence, augmented_loss_mask, augmented_labels = add_cls_and_eos_tokens(
        sequence, loss_mask, labels, cls_token=0, eos_token=None
    )
...
def test_add_cls_and_eos_tokens_only_bos():
    ...
    augmented_sequence, augmented_loss_mask, augmented_labels = add_cls_and_eos_tokens(
        sequence, loss_mask, labels, cls_token=None, eos_token=4
    )
