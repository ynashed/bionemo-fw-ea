...
def test_dataloading_batch_size_one_work_without_collate(tmpdir, get_test_directory):
    ds = SingleCellMemMapDataset(f"{tmpdir}/scy", h5ad_path=get_test_directory / "adata_sample1.h5ad")
...
def test_dataloading_batch_size_one_works_with_collate(tmpdir, get_test_directory):
    ds = SingleCellMemMapDataset(f"{tmpdir}/scy", h5ad_path=get_test_directory / "adata_sample1.h5ad")
...
def test_dataloading_batch_size_three_works_with_collate(tmpdir, get_test_directory):
    ds = SingleCellMemMapDataset(f"{tmpdir}/scy", h5ad_path=get_test_directory / "adata_sample1.h5ad")
