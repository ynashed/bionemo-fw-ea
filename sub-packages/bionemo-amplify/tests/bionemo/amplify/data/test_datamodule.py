...
def test_create_amplify_datamodule_raises_without_trainer(dummy_protein_dataset, dummy_parquet_train_val_inputs):
...
def test_create_amplify_datamodule_raises_without_trainer_max_steps(dummy_protein_dataset, dummy_parquet_train_val_inputs):
    train_cluster_path, valid_cluster_path = dummy_parquet_train_val_inputs
...
def test_create_amplify_datamodule_creates_valid_dataloaders(dummy_protein_dataset, dummy_parquet_train_val_inputs):
    train_cluster_path, valid_cluster_path = dummy_parquet_train_val_inputs
...
def test_create_amplify_datamodule_creates_valid_dataloaders_fractional_limit_val_batches_smaller_than_global_batch_size(
    dummy_protein_dataset, dummy_parquet_train_val_inputs
):
    train_cluster_path, valid_cluster_path = dummy_parquet_train_val_inputs
...
def test_create_amplify_datamodule_creates_valid_dataloaders_fractional_limit_val_batches_0(
...
def test_create_amplify_datamodule_creates_valid_dataloaders_fractional_limit_val_batches_not_multiple_of_global_batch_size(
    dummy_protein_dataset, dummy_parquet_train_val_inputs
):
    train_cluster_path, valid_cluster_path = dummy_parquet_train_val_inputs
...
def test_create_amplify_datamodule_creates_valid_dataloaders_fractional_limit_val_batches_1p0(
    dummy_protein_dataset, dummy_parquet_train_val_inputs
):
    train_cluster_path, valid_cluster_path = dummy_parquet_train_val_inputs
...
def test_create_amplify_datamodule_limit_val_batches_none_equals_limit_val_batches_1p0(
    dummy_protein_dataset, dummy_parquet_train_val_inputs
):
    train_cluster_path, valid_cluster_path = dummy_parquet_train_val_inputs

    # Initialize the data module with limit_val_batches = 1.0
    data_module_one = AMPLIFYDataModule(
        train_cluster_path=train_cluster_path,
        train_database_path=dummy_protein_dataset,
        valid_cluster_path=valid_cluster_path,
        valid_database_path=dummy_protein_dataset,
    ...
    data_module_none = AMPLIFYDataModule(
        train_cluster_path=train_cluster_path,
        train_database_path=dummy_protein_dataset,
        valid_cluster_path=valid_cluster_path,
        valid_database_path=dummy_protein_dataset,
...
def test_create_amplify_datamodule_valid_dataloaders_has_consistent_samples_per_epoch(
    dummy_protein_dataset, dummy_parquet_train_val_inputs
):
    """
    Test that the AMPLIFYDataModule dataloaders produce consistent samples per epoch.

    This test ensures that the AMPLIFYDataModule creates dataloaders that produce consistent
